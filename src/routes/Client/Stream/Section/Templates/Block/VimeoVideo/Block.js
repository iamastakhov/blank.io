...
import { FaVimeo, FaHeart, FaMailForward, FaComment, FaEllipsisH, FaPlay, FaPause, FaVolumeUp, FaArrowsAlt } from 'react-icons/lib/fa';
...
<div className={s.Right}>
  ...
  <FaVimeo className={cx(s.Glyph, s.Right)} />
  </a>
