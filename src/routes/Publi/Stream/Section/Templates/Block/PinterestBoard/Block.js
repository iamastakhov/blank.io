...
import { FaPinterest, FaHeart, FaMailForward, FaComment, FaEllipsisH, FaBackward, FaPlay, FaForward } from 'react-icons/lib/fa';
...
<div className={s.Right}>
  ...
  <FaPinterest className={cx(s.Glyph, s.Right)} />
  </a>
