...
import { FaYoutube, FaList, FaPlay, FaPause, FaVolumeUp, FaArrowsAlt, FaHeart, FaMailForward, FaComment, FaEllipsisH } from 'react-icons/lib/fa';
...
<div className={s.Right}>
  ...
  <FaYoutube className={cx(s.Glyph, s.Right)} />
  </a>
